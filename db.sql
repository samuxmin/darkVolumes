...
CREATE TABLE `ADMIN` (
  ...
  PRIMARY KEY (`email`),
  CONSTRAINT `ADMIN_ibfk_1` FOREIGN KEY (`email`) REFERENCES `user` (`email`)
...
INSERT INTO `ADMIN` VALUES ('admin@mail.com');
...
CREATE TABLE `cart` (
  ...
  KEY `bookId` (`bookId`),
  CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`usermail`) REFERENCES `user` (`email`),
  CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`bookId`) REFERENCES `volume` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `saleDetails` VALUES (22,'sam@mail.com','2023-12-16',NULL),(23,'sam@mail.com','2023-12-16',NULL),(24,'sam@mail.com','2023-12-16',NULL),(25,'sam@mail.com','2023-12-16',NULL),(26,'sam@mail.com','2023-12-16',NULL),(27,'sam@mail.com','2023-12-16',NULL),(28,'sam@mail.com','2023-12-16',NULL),(29,'sam@mail.com','2023-12-16',NULL),(30,'sam@mail.com','2023-12-16',NULL),(31,'sam@mail.com','2023-12-16',NULL),(32,'sam@mail.com','2023-12-16',NULL),(33,'sam@mail.com','2023-12-16',NULL),(34,'sam@mail.com','2023-12-16',NULL),(35,'sam@mail.com','2023-12-16',NULL),(36,'sam@mail.com','2023-12-16',NULL),(37,'sam@mail.com','2023-12-16',NULL),(38,'sam@mail.com','2023-12-16',80);
...
INSERT INTO `user` VALUES ('admin@mail.com','soyadmin','$2b$12$5byp91Bwbq28milNoxdebOT4PkjEJUcYiZLS0AB8wCjG.jyh2Q9P2','2022-02-12'),('mail@mail.com','papu','$2b$12$7MeSCDzEBbCEhS5Q8flJAONXN5sC1I/NTRQ1GqHjaKIBLbHwrOi.i','2022-02-12'),('papa','pepe','$2b$12$nYJoJStxWFTGehc/XG0OLexYzJq0jiCNwP71G7lobRyzVcT58gw3K','2022-02-12'),('sam@mail.com','hellboy','1234','2002-07-22');
...
-- Dump completed on 2023-12-18 15:22:08
